(function() {
  ...
  test('encodes private key correctly', function() {
    return equals(key1.privatePEM(), correctPrivatePEM);
  });
  test('encodes public key correctly', function() {
    ...
    return equals(key1.publicPEM(), correctPublicPEM);
  });
  module('PEM Decoder');
  test('decodes private key correctly', function() {
    var key2;
    key2 = new RSAKey();
    ...
    return equals(key2.coeff.toString(16), key1.coeff.toString(16));
  });
  ...
  test('decrypts OpenSSL output', function() {
    ...
    return equals(key1.decrypt(ciphertext), 'test_vector');
  });
})();
